        ...
        <div class="card-body">
            <form id="formEmployee" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" name="timezone" value="Europe/Berlin" required>
                </div>
                <div class="col-md-3">
...
<div class="modal fade" id="weekReportModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <form method="post" action="<?= h(url('/reports/week.pdf')) ?>" target="_blank" id="weekReportForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="small text-secondary mt-3">Für jeden ausgewählten Mitarbeiter wird eine eigene PDF-Seite mit Unterschriftsfeld erstellt.</div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Abbrechen</button>
                    <button type="submit" class="btn btn-primary">PDF öffnen</button>
                </div>
            </form>
        </div>
    </div>
